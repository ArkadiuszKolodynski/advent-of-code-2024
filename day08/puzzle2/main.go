	...
	for _, v := range dict {
		for i := 0; i < len(v); i++ {
			for j := i + 1; j < len(v); j++ {
				...
				antinodes[fmt.Sprintf("%d,%d", v[i][0], v[i][1])] = true
				antinodes[fmt.Sprintf("%d,%d", v[j][0], v[j][1])] = true
				...
				for antinode1[0] >= 0 && antinode1[0] < rowsCount && antinode1[1] >= 0 && antinode1[1] < colsLength {
					antinode1[0] -= idiff
					antinode1[1] -= jdiff
					if antinode1[0] >= 0 && antinode1[0] < rowsCount && antinode1[1] >= 0 && antinode1[1] < colsLength {
						antinodes[fmt.Sprintf("%d,%d", antinode1[0], antinode1[1])] = true
				...
				for antinode2[0] >= 0 && antinode2[0] < rowsCount && antinode2[1] >= 0 && antinode2[1] < colsLength {
					antinode2[0] += idiff
					antinode2[1] += jdiff
					if antinode2[0] >= 0 && antinode2[0] < rowsCount && antinode2[1] >= 0 && antinode2[1] < colsLength {
						antinodes[fmt.Sprintf("%d,%d", antinode2[0], antinode2[1])] = true
